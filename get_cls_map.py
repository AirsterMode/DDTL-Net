...
def get_cls_map(net, device, all_data_loader, y, dataset_name, net_name):
    ...
    classification_map(y_re, y, 300,
                       'classification_maps/' + dataset_name + '_' + net_name + '_predictions.eps')
    classification_map(y_re, y, 300,
                       'classification_maps/' + dataset_name + '_' + net_name + '_predictions.png')
    classification_map(gt_re, y, 300,
                       'classification_maps/' + dataset_name + '_gt.png')
